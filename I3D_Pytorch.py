...
class I3D(nn.Module):
	...
	self.features_1 = self.features_1.cuda(0)
	self.features_2 = self.features_2.cuda(1)
	self.features_3 = self.features_3.cuda(1)
	self.features_4 = self.features_4.cuda(2)
        self.spatial_squeeze = spatial_squeeze
    def forward(self, x):
        logits = self.features_1(x).cuda(1)
        logits = self.features_2(logits).cuda(1)
	logits = self.features_3(logits).cuda(2)
	logits = self.features_4(logits)
